...
// https://godoc.org/github.com/brucejrc/iris/core/router#Router.WrapRouter
//
// Example: https://github.com/brucejrc/iris/tree/master/_examples/beginner/file-server/single-page-application-builder
