...
import (
	...
	"github.com/brucejrc/iris/core/host"
	"github.com/brucejrc/iris/core/logger"
	"github.com/brucejrc/iris/core/nettools"
	"github.com/brucejrc/iris/core/router"
	// sessions and view
	"github.com/brucejrc/iris/sessions"
	"github.com/brucejrc/iris/view"
	// middleware used in Default method
	requestLogger "github.com/brucejrc/iris/middleware/logger"
	"github.com/brucejrc/iris/middleware/recover"
)
...
const (
	...
	//
	// Look https://github.com/brucejrc/iris#where-can-i-find-older-versions for older versions.
	Version = "7.2.0"
)
...
//
// Example: https://github.com/brucejrc/iris/tree/master/_examples/beginner/file-server/single-page-application
